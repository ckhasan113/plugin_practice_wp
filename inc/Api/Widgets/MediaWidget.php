...
class MediaWidget extends WP_Widget{
  ...
  {
    $this->widget_ID = 'mh_media_widget';
    $this->widget_name = 'MH Media Widget';
   ...
   * widget()
   * 
   * generate frontend output for the widget
   */
   ...
   * form()
   * 
   * generate administration area output for the widget
   */
   ...
   * update()
   * 
   * updating the information in widgets
   */
