...
class CustomPostTypeController extends BaseController
{
  ...
  {
    $args[] = array(
      'option_group' => 'mh_admin_cpt_settings',
      'option_name' => 'mh_admin_cpt',
  ...
  public function setFields()
  {
    ...
    $args = array(
      ...
      array(
          ...
          'page' => 'mh_cpt',
          'section' => 'mh_cpt_index',
          'args' => array(
            'option_name' => 'mh_admin_cpt',
            'label_for' => 'post_type',
            'placeholder' => 'eg. mh_product',
          )
        ),
  ...
  /**
   * Store Custom post type value function
   *
   * @return void
   */
  public function storeCustomPostType(){
    ...
    foreach($options as $option){
      ...
      $this->custom_post_types[] = array(
        ...
        'has_archive'           => isset($option['has_archive']) ? $option['has_archive'] : false,
        ...
        'insert_into_item'      => 'Inser into '.$option['singular_name'],
