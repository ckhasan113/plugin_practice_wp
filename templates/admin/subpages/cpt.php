  ...
  <div class="tab-content">
    ...
    <h3>Manage Your Custom Post Types</h3>
      ...
      <?php
        ...
        $options = get_option('mh_admin_cpt') ?: array();
        ...
        foreach($options as $option){
          ...
          submit_button('Delete', 'delete small', 'submit', false, array(
            'onclick' => 'return confirm("\rAre you sure you want to delete this Custom Post Type?\r\n\nThe data associated with it will not be deleted.\n")'
          )); 
          /**
           * submit_button()
           * 
           * 
           * 1st parameter is the value of the button
           * 2nd parameters are the class names
           * 3rd is the button type
           * 4th is wwraper - wraper handels the html code which wrap the button
           * 5th & final parameter - this is an array list which have all the attributes listed that we want to sotre in this button
           */
    ...
    <h3>Export Your Custiom Post Type</h3>
